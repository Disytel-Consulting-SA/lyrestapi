...
public interface UserApi {
    ...
    @Operation(summary = "Retorna la lista de usuarios", description = "Retorna la lista completa de usuarios", security = {
        @SecurityRequirement(name = "jwtAuth")    }, tags={ "user" })
    @ApiResponses(value = { 
