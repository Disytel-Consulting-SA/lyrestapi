...
public interface InventorylineApi {
    ...
    Logger log = LoggerFactory.getLogger(InventorylineApi.class);
    ...
    @Operation(summary = "Nueva linea de inventario", description = "Agrega una nueva linea de inventario", security = {
        @SecurityRequirement(name = "jwtAuth")    }, tags={ "inventoryline" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK. ID de linea de inventario creado es retornado", content = @Content(mediaType = "text/plain", schema = @Schema(implementation = String.class))),
    ...
    @RequestMapping(value = "/v1.0/inventorylines",
        produces = { "text/plain" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    default ResponseEntity<String> addInventoryLine(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody InventoryLine body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default InventorylineApi interface so no example is generated");
        }
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    }


    @Operation(summary = "Elimina una linea de inventario", description = "Elimina una linea de inventario existente", security = {
        @SecurityRequirement(name = "jwtAuth")    }, tags={ "inventoryline" })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/v1.0/inventorylines/{id}",
        produces = { "text/plain" }, 
        method = RequestMethod.DELETE)
    default ResponseEntity<String> deleteInventoryLine(@Parameter(in = ParameterIn.PATH, description = "ID de la linea de inventario", required=true, schema=@Schema()) @PathVariable("id") Integer id) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("\"\"", String.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    @Operation(summary = "Recupera una linea de inventario en particular", description = "Recupera la informacion de una linea de inventario en particular", security = {
        @SecurityRequirement(name = "jwtAuth")    }, tags={ "inventoryline" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InventoryLine.class))) })
    @RequestMapping(value = "/v1.0/inventorylines/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<InventoryLine> retrieveInventoryLine(@Parameter(in = ParameterIn.PATH, description = "ID de la linea de inventario", required=true, schema=@Schema()) @PathVariable("id") Integer id) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{\n  \"qtycount\" : 1.2315135367772556,\n  \"qtyinternaluse\" : 1.4894159098541704,\n  \"cost\" : 5.962133916683182,\n  \"m_product_id\" : 4,\n  \"updatedby\" : 6,\n  \"ad_org_id\" : 6,\n  \"created\" : \"created\",\n  \"line\" : 2,\n  \"isactive\" : true,\n  \"referencedvalues\" : [ {\n    \"value\" : \"value\",\n    \"key\" : \"key\"\n  }, {\n    \"value\" : \"value\",\n    \"key\" : \"key\"\n  } ],\n  \"c_charge_id\" : 1,\n  \"m_locator_id\" : 2,\n  \"description\" : \"description\",\n  \"qtycountwithoutchargesign\" : 1.0246457001441578,\n  \"processed\" : true,\n  \"m_inventoryline_id\" : 3,\n  \"inventorytype\" : \"inventorytype\",\n  \"createdby\" : 5,\n  \"m_inventory_id\" : 9,\n  \"qtybook\" : 7.386281948385884,\n  \"m_attributesetinstance_id\" : 7,\n  \"ad_client_id\" : 0,\n  \"updated\" : \"updated\"\n}", InventoryLine.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    @Operation(summary = "Actualiza una linea de inventario existente", description = "", security = {
        @SecurityRequirement(name = "jwtAuth")    }, tags={ "inventoryline" })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<String> updateInventoryLine(@Parameter(in = ParameterIn.PATH, description = "ID de la linea de inventario a actualizar", required=true, schema=@Schema()) @PathVariable("id") Integer id, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody InventoryLine body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("\"\"", String.class), HttpStatus.NOT_IMPLEMENTED);
